...
from vehicle_insurance.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from vehicle_insurance.entity.config_entity import DataValidationConfig
from vehicle_insurance.constants import SCHEMA_FILE_PATH
